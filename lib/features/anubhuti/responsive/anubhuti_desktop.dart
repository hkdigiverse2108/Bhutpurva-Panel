...
class AnubhutiDesktop extends StatelessWidget {
  const AnubhutiDesktop({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = AnubhutiController.instance;
    return AdminTablePageLayout(
      header: BreadcrumbWithHeading(
        heading: 'Anubhuti',
        breadcrumbsItems: [BreadcrumbItem(title: 'Anubhuti')],
      ),
      ...
      body: Obx(() {
        ...
        return AppPaginatedTable<AnubhutiModel>(
          columns: [
